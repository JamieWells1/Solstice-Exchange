...
{
    auto bidOrder = Order::createOrder(1, Equity::AAPL, 105.0, 10.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder.has_value());
    orderBook->addOrderToBook(*bidOrder);
...
{
    auto bidOrder = Order::createOrder(1, Equity::AAPL, 95.0, 10.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder.has_value());
    orderBook->addOrderToBook(*bidOrder);
...
{
    auto bidOrder = Order::createOrder(1, Equity::AAPL, 100.0, 5.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder.has_value());
    orderBook->addOrderToBook(*bidOrder);
...
{
    auto bidOrder1 = Order::createOrder(1, Equity::AAPL, 100.0, 3.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder1.has_value());
    orderBook->addOrderToBook(*bidOrder1);

    auto bidOrder2 = Order::createOrder(2, Equity::AAPL, 100.0, 3.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder2.has_value());
    orderBook->addOrderToBook(*bidOrder2);

    auto bidOrder3 = Order::createOrder(3, Equity::AAPL, 100.0, 4.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder3.has_value());
    orderBook->addOrderToBook(*bidOrder3);

    auto askOrder = Order::createOrder(4, Equity::AAPL, 100.0, 10.0, OrderSide::Ask);
    ASSERT_TRUE(askOrder.has_value());
...
{
    auto bidOrder = Order::createOrder(1, Equity::AAPL, 100.0, 15.0, OrderSide::Bid);
    ASSERT_TRUE(bidOrder.has_value());
    orderBook->addOrderToBook(*bidOrder);
